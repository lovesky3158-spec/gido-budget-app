...
const DEFAULT_WIFE_MESSAGE = "럭키비키야 엄마아빠 돈열심히 모아서 부자될게!! 빵빵이도~~ 💛";
            ...
            {!currentMonth ? (
              ...
              <div className="grid gap-4 lg:grid-cols-[430px_minmax(0,1fr)] lg:items-start">
                <div className="grid gap-4 rounded-[26px] border border-slate-200 bg-white p-3 shadow-[0_18px_44px_rgba(139,92,0,0.10)] sm:rounded-[34px] sm:p-5">
                  <div className="rounded-[22px] border border-[#f4dc87] bg-[linear-gradient(135deg,#fffaf0,#fff2bd)] p-5 sm:rounded-[28px] sm:p-6">
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <div className={`mt-1 break-keep text-[26px] font-black leading-tight tracking-[-0.06em] ${amountTone(netAmount)} sm:text-[32px]`}>
                  ...
                  <div className="rounded-[22px] bg-emerald-50 p-4 ring-1 ring-emerald-100 sm:rounded-[26px] sm:p-5">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="break-keep text-[22px] font-black leading-tight tracking-[-0.05em] text-emerald-700 sm:text-[28px]">
                  ...
                  <div className="rounded-[22px] border border-yellow-200 bg-[linear-gradient(135deg,#fff1a8,#ffd84d)] p-5 shadow-[0_10px_22px_rgba(255,191,31,0.18)] sm:rounded-[28px] sm:p-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="break-keep text-[22px] font-black leading-tight tracking-[-0.05em] text-[#b45309] sm:text-[28px]">
                ...
                <section className="rounded-[26px] border border-slate-200 bg-white p-4 shadow-[0_12px_30px_rgba(15,23,42,0.04)] sm:rounded-[30px] sm:p-6 lg:min-h-[560px]">
                      ...
                      recentRows.map((row) => {
                        ...
                        return (
                          <div
                            ...
                            className="rounded-[22px] bg-slate-50 px-4 py-4 transition hover:bg-slate-100/80 sm:px-5 sm:py-5"
                          >
                            <div className="flex min-w-0 items-center justify-between gap-4">
                              <div className="min-w-0 flex-1">
                                <div className="line-clamp-2 break-keep text-[15px] font-semibold leading-snug text-[#2a2112] sm:text-[15px]">
                                  {row.description || "-"}
                                </div>
